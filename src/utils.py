...
from numba import jit  # 移除cuda import，只保留CPU版本
import math
...
class Normalize(object):
    ...
    def __call__(self, inputs):
        ...
        inputs[0:1, :, :] = (inputs[0:1, :, :] - 50) / 50.0
        inputs[1:3, :, :] = inputs[1:3, :, :] / 127.0
        return inputs
...
class Distortion_with_flow_cpu(object):
    """Elastic distortion - CPU version only"""
